...
def apogee_fields(fs1, rTarget, fs2, r2Target, rfile):
    ...
    print("\n010 \napogee_fields: fs1 " + str(fs1.shape[0]))
    print("apogee_fields: fs2 " + str(fs2.shape[0]))
    ...
    print("\n011 Remove bad stars \napogee_fields: s1 " + str(s1.shape[0]))
    print("apogee_fields: s2 " + str(s2.shape[0]))
    ...
    image = plt.scatter(x1, y1,s=10, label=s1Label +  ' Stars '  + str(x1.shape[0]),
                c=ss1.FE_H,edgecolor='k',cmap="jet_r")
    ...
    bar.set_label('M_H',size=15)
    plt.show()
    
    ################################################################################
    print("apogee_fields: Plot 011aa")
    ...
    image = plt.scatter(x2, y2,s=10, label=s2Label +  ' Stars '  + str(x2.shape[0]),
                c=ss2.FE_H,edgecolor='k',cmap="jet_r")
    ...
    plt.title("Aluminum AL_FE \nFormed by carbon burning in massive stars \nReleased to the ISM via SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    sns.distplot(x2[(x2 >= rLow) & (x2 <= rHi)], color='b', hist=True, 
                    label=s2Label.strip() + " Stars " + str(x2.shape[0]))
    plt.xlabel('C_FE (C stable alpha element)', fontsize=13)
    ...
    plt.title("Calcium CA_FE \nProduced in massive stars through oxygen and silicon burning \nReleased into the ISM via SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Chromium CR_FE \nProduced in explosive silicon burning \nReleased into the ISM via both SNe II and SNe Ia", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Potassium K_FE \nProduce of explosive oxygen burning \nReleased into the ISM via SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    sns.distplot(x2[(x2 >= rLow) & (x2 <= rHi)], color='b', hist=True, 
                    label=s2Label.strip() + " Stars " + str(x2.shape[0]))
    plt.xlabel('MG_FE (Mg stable alpha element)', fontsize=13)
   
    plt.title("Magnesium MG_FE \nProduced via carbon burning \nAn alpha-element returned to the ISM via SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Manganese MN_FE \nProduced by explosive silicon burning and in the alpha-rich freezeout in SNe II\nReleased into the ISM via both SNe II and SNe Ia", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Nitrogen N_FE \nProduced in the CN cycle by intermediate-mass AGB stars \nReleased into the ISM via stellar winds", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Sodium NA_FE \nProduced by explosive carbon burning in SNe II \nReleased into the ISM via SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Nickel NI_FE \nProduced by explosive silicon burning in the alpha-rich freezeout in SNe II and by the weak-s-process \nReleased into the ISM via both SNe IIand SNe Ia", 
              fontsize=13)
    ...
    sns.distplot(x2[(x2 >= rLow) & (x2 <= rHi)], color='b', hist=True, 
                    label=s2Label.strip() + " Stars " + str(x2.shape[0]))
    plt.xlabel('O_FE (O stable alpha element)', fontsize=13)
   
    plt.title("Oxygen O_FE \nProduced by massive stars through helium burning \nReleased into the ISM via SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Phosphorus P_FE \nFormed by carbon and neon burning in massive stars", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    sns.distplot(x2[(x2 >= rLow) & (x2 <= rHi)], color='b', hist=True, 
                    label=s2Label.strip() + " Stars " + str(x2.shape[0]))
    plt.xlabel('S_FE (S stable alpha element)', fontsize=13)
    
    plt.title("Sulfur S_FE \nProduced via oxygen burning in massive stars \nReleased into the ISM by SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    sns.distplot(x2[(x2 >= rLow) & (x2 <= rHi)], color='b', hist=True, 
                    label=s2Label.strip() + " Stars " + str(x2.shape[0]))
    plt.xlabel('SI_FE (Si stable alpha element)', fontsize=13)
    
    plt.title("Silicon SI_FE \nProduced in oxygen burning \nDeposited into the ISM by both SNe II and SNe Ia", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    plt.title("Titanium TI_FE \nFormed by explosive silicon burning and fusion of helium nuclei \nReleased into the ISM via SNe II", 
              fontsize=13)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    #plt.legend(fontsize=13)
    ...
    print("\nEnd of Apogee Functions New CSV")
...
def apogee_target2(rTarget, rFlag, rBit, r2Target, r2Flag, r2Bit):
    ...
    hdulist = pyfits.open('allStarLite-r12-l33.fits') # DR16
    ...
    ################################################################################
    print("\napogee_target2; Step 4: VHELIO_AVG" )
    ...
    ################################################################################
    print("\napogee_target2; Step 5: Plot Teff vs Logg" )
    ...
    ###############################################################################
    print("\napogee_target2; Step 6: Plot Teff vs J-K" )
    ...
    ###############################################################################
    print("\napogee_target2; Step 7: Plot Teff vs J-K" )
    ...
    ################################################################################
    print("\napogee_target2; Step 6: Plot Fd Teff vs J-K" )
    ...
    print("\napogee_target2; Step 7: Plot Fd Teff vs J-K" )
    ...
    ################################################################################
    print("\napogee_target2; Step 8: Plot GKd Teff vs J-K" )
    ...
    print("\napogee_target2; Step 9: Plot GKd Teff vs J-K" )
    ...
    ################################################################################
    print("\napogee_target2; Step 10: Plot GKg Teff vs J-K" )
    ...
    print("\napogee_target2; Step 11: Plot GKg Teff vs J-K" )
    ...
    ################################################################################
    print("\napogee_target2; Step 12: Plot Histogram GKg Teff" )
    ...
    print("\napogee_target2; Step 13: Plot Histogram GKg Teff" )
    ...
    ################################################################################
    print("\napogee_target2; Step 14: Plot Histogram GKd Teff" )
    ...
    print("\napogee_target2; Step 15: Plot Histogram GKd Teff" )
    ...
    ################################################################################
    print("\napogee_target2; Step 16: Plot Scatter Glon Glat" )
    ...
    print("\napogee_target2; Step 17: Plot Scatter Glon Glat" )
    ...
    ################################################################################
    print("\napogee_target2; Step 18: Plot Histogram Survey" )
    ...
    print("\napogee_target2; Step 19: Plot Histogram Survey" )
    ...
    ################################################################################
    print("\napogee_target2; Step 20: Plot Histogram ALPHA_M ")
    ...
    ################################################################################
    print("\napogee_target2; Step 21: DistPlot LogG")
    ...
    ################################################################################
    print("\napogee_target2; Step 22: DistPlot M_H")
    ...
    ################################################################################
    print("\napogee_target2; Step 23: DistPlot FE_H")
    ...
    ################################################################################
    print("\napogee_target2; Step 24: DistPlot Teff")
    ...
    ################################################################################
    print("\napogee_target2; Step 25: DistPlot SNR")
    ...
    ################################################################################
    print("\napogee_target2; Step 26: DistPlot VHELIO_AVG")
    ...
    ################################################################################
    print("\napogee_target2; Step 27: DistPlot VSCATTER")
    ...
    ################################################################################
    print("\napogee_target2; Step 28: DistPlot VMACRO")
    ...
    ################################################################################
    print("\napogee_target2; Step 29: DistPlot VMICRO")
    ...
    ################################################################################
    print("\napogee_target2; Step 30: DistPlot J")
    ...
    ################################################################################
    print("\napogee_target2; Step 31: DistPlot H")
    ...
    ################################################################################
    print("\napogee_target2; Step 32: DistPlot K")
